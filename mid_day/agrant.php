...
<div class="head2">
    ...
    <div class="loginform">
           <form method="POST" action="agrant1.php" onsubmit="return validation()" name="f1">
            <h1 style="text-align:center">View Grants Made</h1>
                          <br>
                          <br>
                          <label for="cars"><h3>Select a school:</h3></label>
